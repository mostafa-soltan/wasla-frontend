            ...
            <div class="row justify-content-center">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"><img src="{{ asset('assets/img/gallery/socialEvents1.png') }}" alt=""></a>
                            </div>
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"><img src="{{ asset('assets/img/gallery/socialEvents2.png') }}" alt=""></a>
                            </div>
                            <div class="job-tittle">
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"><img src="{{ asset('assets/img/gallery/socialEvents3.png') }}" alt=""></a>
                            </div>
                            <div class="job-tittle">
