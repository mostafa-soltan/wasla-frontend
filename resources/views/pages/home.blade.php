        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-10 col-sm-10">
                    <!-- Section Tittle -->
                    <div class="section-tittle text-center mb-80">
                        <span>Our Projects you can see</span>
                        <h2>Explore our latest projects that we works</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cases mb-40">
                        <div class="cases-img">
                            <img src="{{ asset('assets/img/gallery/case1.png') }}" alt="" />
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cases mb-40">
                        <div class="cases-img">
                            <img src="{{ asset('assets/img/gallery/case2.png') }}" alt="" />
                        </div>
                        <div class="cases-caption">
                            <h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cases mb-40">
                        <div class="cases-img">
                            <img src="{{ asset('assets/img/gallery/case3.png') }}" alt="" />
                        </div>
                        <div class="cases-caption">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"
                                ><img src="{{ asset('assets/img/gallery/socialEvents1.png') }}" alt=""
                                    /></a>
                            </div>
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"
                                ><img src="{{ asset('assets/img/gallery/socialEvents2.png') }}" alt=""
                                    /></a>
                            </div>
                            <div class="job-tittle">
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"
                                ><img src="{{ asset('assets/img/gallery/socialEvents3.png') }}" alt=""
                                    /></a>
                            </div>
                            <div class="job-tittle">
